...
<title>Ocas Medina Guillermo Andre Sebastian </title>
</head>
<body> 
 ...
 <h1>Crud de Producto</h1>
		 <div class="col-md-23" >  
			  <form id="idFormElimina" action="eliminaProducto">
		       ...
		       <form accept-charset="UTF-8"  action="listaProducto" class="simple_form" id="defaultForm2"  method="get">
		       		<div class="row">
						<div class="col-md-3">	
										...
										<tbody>
												...
												<c:forEach items="${productos}" var="x">
													<tr>
														...
														<td>${x.stock}</td>	
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idProducto}','${x.nombre}','${x.marca}','${x.precio}','${x.stock}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_marca" name="marca" placeholder="Ingrese la marca del producto" type="text" maxlength="45"/>
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_stock" name="stock" placeholder="Ingrese stock" type="text" maxlength="10"/>
		                                        </div>
		                                    </div> 
		                                    <div class="form-group">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_marca" name="marca" placeholder="Ingrese la marca" type="text" maxlength="30"/>
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_stock" name="stock" placeholder="Ingrese stock" type="text" maxlength="10"/>
		                                        </div>
		                                    </div>  
		                                    <div class="form-group">
		                                        <div class="col-lg-9 col-lg-offset-3">
...
function editar(id,nombre,marca,precio,stock){	
	$('input[id=id_ID]').val(id);
	$('input[id=id_act_nombre]').val(nombre);
	$('input[id=id_act_marca]').val(marca);
	...
	$('#id_form_actualiza').bootstrapValidator({
        ...
        fields: {
            ...
            stock: {
                ...
                validators: {
                    notEmpty: {
                        message: 'La precio es un campo obligatorio'
                    },
