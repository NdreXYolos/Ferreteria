										...
										<tbody>
												...
												<c:forEach items="${clientes}" var="x">
													<tr>
														...
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idCliente}','${x.nombre}','${x.apellido}','${x.fechaNacimiento}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
		                        ...
		                        <div class="panel panel-default">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_fechaNacimiento">Fecha Nacmiento</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_fechaNacimiento" name="fechaNacimiento" placeholder="Ingrese la fecha" type="text" maxlength="10"/>
		                                        </div>
		                                    </div>		                                  
		                                    <div class="form-group">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_fechaNacimiento" name="fechaNacimiento" placeholder="Ingrese la fecha" type="text" maxlength="10"/>
		                                        </div>
		                                    </div>
...
function editar(id,nombre,apellido,fechaNacimiento){	
	...
	$('#id_form_actualiza').bootstrapValidator({
        ...
        fields: {
        	...
        	dni: {
                ...
                validators: {
                    notEmpty: {
                        message: 'La fecha de nacimientoes un campo obligatorio'
                    },
